...
@app.get("/ipo/general")
async def ipo_general(size: int = 5): return await fetch_offerings(0, 2, size)

@app.get("/ipo/local")
async def ipo_local(size: int = 5): return await fetch_offerings(0, 0, size)

@app.get("/ipo/foreign")
async def ipo_foreign(size: int = 5): return await fetch_offerings(0, 1, size)

@app.get("/right-share")
async def right_share(size: int = 5): return await fetch_offerings(2, 2, size)

@app.get("/fpo")
async def fpo(size: int = 5): return await fetch_offerings(1, 2, size)

@app.get("/mutual-fund-offering")
async def mutual_fund_offering(size: int = 5): return await fetch_offerings(3, 2, size)

@app.get("/debenture-offering")
async def debenture_offering(size: int = 5): return await fetch_offerings(4, 2, size)
